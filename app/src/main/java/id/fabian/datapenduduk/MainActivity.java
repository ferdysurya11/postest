...
import id.fabian.datapenduduk.database.AppDatabase;
import id.fabian.datapenduduk.database.wargaEntity;
...
//                    Toast.makeText(getApplicationContext(),""+radiobtnchoose.getText().toString(),Toast.LENGTH_SHORT).show();
            ...
            Objects.requireNonNull(getSupportActionBar()).setTitle("Form Pendaftaran");
...
//                float computeProgress = progress;
                    textViewAngkelValue.setText(String.format(progress + " Tahun"));
